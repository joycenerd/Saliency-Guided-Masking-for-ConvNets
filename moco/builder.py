...
class MoCo(nn.Module):
    ...
    """
    def __init__(self, base_encoder, dim=128, K=65536, m=0.999, T=0.07, mlp=False, alpha=1.0):
        """
    ...
    def forward(self, im_q, im_k, im_t, n_non_sematic=10):
        """
        Input:
